...
- **FR-021**: システムは、Evolution Stepの新規登録自体を変更履歴に含めず、登録完了後に目的、仮説、変更内容、派生元Run、または実行結果Runの値が実際に変わった編集について、対象項目、編集前と編集後の内容、編集日時を変更履歴として保持し、編集日時の順に確認できるようにしなければならない。同じ値の再送および完了しなかった操作の履歴を作成してはならない。
